...
`lib/brazilian_document_wrapper.rb` requires everything and defines module-level `generate_cpf` / `generate_cnpj(formatted = true, alphanumeric: false)`.

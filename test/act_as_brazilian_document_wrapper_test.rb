...
class ActsAsBrazilianDocumentWrapperTest < ActiveSupport::TestCase
  def test_business_protests_brazilian_document_field_should_be_document
    assert_equal 'document', BusinessProtest.brazilian_document_field
  end

  def test_customers_brazilian_document_field_should_be_document
    assert_equal 'cpf', Customer.brazilian_document_field
  end

  def test_customers_brazilian_document_field_behave_like_brazilian_document
